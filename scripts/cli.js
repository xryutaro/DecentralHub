...
const contractABI = require("../artifacts/contracts/Decentralhub.sol/Decentralhub.json").abi;

program
    .name("decentralhub-cli")
    .description("CLI tool for Decentralhub smart contract")
    .version("1.0.0");
