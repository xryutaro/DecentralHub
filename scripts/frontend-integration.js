 ...
 * This file demonstrates how to integrate Decentralhub with a web frontend
 */

// For React/Vue/Angular applications
export class DecentralhubClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new DecentralhubClient(provider, contractAddress);
